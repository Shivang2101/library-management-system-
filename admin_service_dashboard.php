...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/ITMBU.png"/></div>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="School of Pharmacy"/>School of Pharmacy<div style="margin-left:80px"><input type="radio" name="branch" value="School of Computer Science"/>School of Computer Science<input type="radio" name="branch" value="School of Bussiness"/>School of Bussiness</div>
            </div>   
...
// Check if index 10 exists in the $row array before accessing it
if (isset($row[10])) {
    $table .= "<td>$row[10]</td>";
} 
